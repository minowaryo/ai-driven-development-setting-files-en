...
- `.claude/rules/30-testing.md` (the "E2E Test (Playwright)" section)
...
3. Save the test as `tests/e2e/{UC-number}-{flow-summary}.spec.ts` (see `.claude/rules/30-testing.md` for naming conventions)
